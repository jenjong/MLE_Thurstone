...
# include "rtn.h"
// [[Rcpp::export]]
Rcpp::NumericVector rtnRcpp( Rcpp::NumericVector mean, ///< vector of length K
					 ///containing the mean of the
					 ///distribution for each draw
					 ///[real number]

					Rcpp::NumericVector sd, ///< vector of length K
				       ///containing the standard
				       ///deviation for each draw
				       ///[strictly positive real
				       ///number]
				  Rcpp::NumericVector low, ///< vector of length K
					///containing the lower bound
					///for each draw [real number
					///or '-Inf']
					Rcpp::NumericVector high ///< vector of length K
